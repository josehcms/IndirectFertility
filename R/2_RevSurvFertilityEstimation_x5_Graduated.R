...
###        Sprague and Beers-Mod graduation 
...
write.table( outRevSurvBeers, 
             file = 'outputs/reverse_survival_fertestr_world_x5_beers.csv', 
             row.names = F )
...
write.table( outRevSurvSprague, 
             file = 'outputs/reverse_survival_fertestr_world_x5_sprague.csv', 
             row.names = F )
...
write.table( outRevSurv, 
             file = 'outputs/reverse_survival_fertestr_world_x5_graduated.csv', 
             row.names = F )
